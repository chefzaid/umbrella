...
/**
 * REST controller for managing {@link io.simpleit.umbrella.domain.Operation}.
 */
@RestController
...
public class OperationResource {
    ...
    public ResponseEntity<Operation> partialUpdateOperation(
        ...
        Optional<Operation> result = operationService.partialUpdate(operation);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Operation>> getAllOperations(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
