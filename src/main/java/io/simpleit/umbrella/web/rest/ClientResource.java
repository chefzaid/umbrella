...
/**
 * REST controller for managing {@link io.simpleit.umbrella.domain.Client}.
 */
@RestController
...
public class ClientResource {
    ...
    public ResponseEntity<List<Client>> getAllClients(
        ...
        if ("servicecontract-is-null".equals(filter)) {
            log.debug("REST request to get all Clients where serviceContract is null");
            return new ResponseEntity<>(clientService.findAllWhereServiceContractIsNull(), HttpStatus.OK);
        }

        if ("project-is-null".equals(filter)) {
            log.debug("REST request to get all Clients where project is null");
            return new ResponseEntity<>(clientService.findAllWhereProjectIsNull(), HttpStatus.OK);
        }
