...
/**
 * REST controller for managing {@link io.simpleit.umbrella.domain.AppUser}.
 */
@RestController
...
public class AppUserResource {
    ...
    public ResponseEntity<List<AppUser>> getAllAppUsers(
        ...
        if ("employee-is-null".equals(filter)) {
            log.debug("REST request to get all AppUsers where employee is null");
            return new ResponseEntity<>(appUserService.findAllWhereEmployeeIsNull(), HttpStatus.OK);
        }
