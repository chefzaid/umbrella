...
/**
 * REST controller for managing {@link io.simpleit.umbrella.domain.Contact}.
 */
@RestController
...
public class ContactResource {
    ...
    public ResponseEntity<List<Contact>> getAllContacts(
        ...
        if ("appuser-is-null".equals(filter)) {
            log.debug("REST request to get all Contacts where appUser is null");
            return new ResponseEntity<>(contactService.findAllWhereAppUserIsNull(), HttpStatus.OK);
        }
