...
/**
 * REST controller for managing {@link io.simpleit.umbrella.domain.Project}.
 */
@RestController
...
public class ProjectResource {
    ...
    public ResponseEntity<List<Project>> getAllProjects(
        ...
        if ("timesheet-is-null".equals(filter)) {
            log.debug("REST request to get all Projects where timeSheet is null");
            return new ResponseEntity<>(projectService.findAllWhereTimeSheetIsNull(), HttpStatus.OK);
        }

        if ("expense-is-null".equals(filter)) {
            log.debug("REST request to get all Projects where expense is null");
            return new ResponseEntity<>(projectService.findAllWhereExpenseIsNull(), HttpStatus.OK);
        }

        if ("invoice-is-null".equals(filter)) {
            log.debug("REST request to get all Projects where invoice is null");
            return new ResponseEntity<>(projectService.findAllWhereInvoiceIsNull(), HttpStatus.OK);
        }
