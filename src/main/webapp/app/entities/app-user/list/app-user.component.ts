...
import { EntityArrayResponseType, AppUserService } from '../service/app-user.service';
...
export class AppUserComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAppUser): number => this.appUserService.getAppUserIdentifier(item);
