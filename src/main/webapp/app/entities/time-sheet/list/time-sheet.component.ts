...
import { EntityArrayResponseType, TimeSheetService } from '../service/time-sheet.service';
...
export class TimeSheetComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITimeSheet): number => this.timeSheetService.getTimeSheetIdentifier(item);
