...
import { sampleWithRequiredData } from '../id-document.test-samples';
...
describe('IdDocument Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, IdDocumentComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.idDocuments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to idDocumentService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIdDocumentIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIdDocumentIdentifier).toHaveBeenCalledWith(entity);
