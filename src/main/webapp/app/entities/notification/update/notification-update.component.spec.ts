...
describe('Notification Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, NotificationUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Employee query and add missing value', () => {
      ...
      const author: IEmployee = { id: 1674 };
      notification.author = author;
      const receiver: IEmployee = { id: 29593 };
      notification.receiver = receiver;

      const employeeCollection: IEmployee[] = [{ id: 24556 }];
      jest.spyOn(employeeService, 'query').mockReturnValue(of(new HttpResponse({ body: employeeCollection })));
      const additionalEmployees = [author, receiver];
    ...
    it('Should update editForm', () => {
      const notification: INotification = { id: 456 };
      const author: IEmployee = { id: 27659 };
      notification.author = author;
      const receiver: IEmployee = { id: 28437 };
      notification.receiver = receiver;

      activatedRoute.data = of({ notification });
      comp.ngOnInit();

      expect(comp.employeesSharedCollection).toContain(author);
      expect(comp.employeesSharedCollection).toContain(receiver);
