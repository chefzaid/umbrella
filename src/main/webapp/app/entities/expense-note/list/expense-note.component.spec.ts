...
import { sampleWithRequiredData } from '../expense-note.test-samples';
...
describe('ExpenseNote Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ExpenseNoteComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.expenseNotes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to expenseNoteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExpenseNoteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExpenseNoteIdentifier).toHaveBeenCalledWith(entity);
