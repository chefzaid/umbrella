...
import { sampleWithRequiredData } from '../prospect.test-samples';
...
describe('Prospect Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ProspectComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.prospects?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to prospectService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProspectIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProspectIdentifier).toHaveBeenCalledWith(entity);
