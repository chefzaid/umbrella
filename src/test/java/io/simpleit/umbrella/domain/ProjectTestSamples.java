...
public class ProjectTestSamples {
    ...
    public static Project getProjectSample1() {
        return new Project().id(1L).title("title1").description("description1").dailyRate(1L);
    }

    public static Project getProjectSample2() {
        return new Project().id(2L).title("title2").description("description2").dailyRate(2L);
    }
