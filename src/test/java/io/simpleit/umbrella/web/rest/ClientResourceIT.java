...
import static io.simpleit.umbrella.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME).companyStatus(DEFAULT_COMPANY_STATUS);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME).companyStatus(UPDATED_COMPANY_STATUS);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).companyStatus(UPDATED_COMPANY_STATUS);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).companyStatus(UPDATED_COMPANY_STATUS);
