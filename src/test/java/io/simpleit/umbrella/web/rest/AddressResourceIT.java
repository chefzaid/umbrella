...
import static io.simpleit.umbrella.domain.AddressAsserts.*;
...
class AddressResourceIT {
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.streetAddress(UPDATED_STREET_ADDRESS).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).country(UPDATED_COUNTRY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.country(UPDATED_COUNTRY);
