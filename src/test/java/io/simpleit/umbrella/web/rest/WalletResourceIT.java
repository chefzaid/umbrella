...
import static io.simpleit.umbrella.domain.WalletAsserts.*;
...
class WalletResourceIT {
    ...
    private static final Double DEFAULT_TOTAL_PROVISION = 1D;
    private static final Double UPDATED_TOTAL_PROVISION = 2D;
    ...
    public static Wallet createEntity(EntityManager em) {
        Wallet wallet = new Wallet().totalBalance(DEFAULT_TOTAL_BALANCE).totalProvision(DEFAULT_TOTAL_PROVISION);
        return wallet;
    }
    ...
    public static Wallet createUpdatedEntity(EntityManager em) {
        Wallet wallet = new Wallet().totalBalance(UPDATED_TOTAL_BALANCE).totalProvision(UPDATED_TOTAL_PROVISION);
        return wallet;
    }
    ...
    void getAllWallets() throws Exception {
        ...
        restWalletMockMvc
            ...
            .andExpect(jsonPath("$.[*].totalProvision").value(hasItem(DEFAULT_TOTAL_PROVISION.doubleValue())));
    }
    ...
    void getWallet() throws Exception {
        ...
        restWalletMockMvc
            ...
            .andExpect(jsonPath("$.totalProvision").value(DEFAULT_TOTAL_PROVISION.doubleValue()));
    }
    ...
    void putExistingWallet() throws Exception {
        ...
        updatedWallet.totalBalance(UPDATED_TOTAL_BALANCE).totalProvision(UPDATED_TOTAL_PROVISION);
    ...
    void partialUpdateWalletWithPatch() throws Exception {
        ...
        partialUpdatedWallet.totalProvision(UPDATED_TOTAL_PROVISION);
    ...
    void fullUpdateWalletWithPatch() throws Exception {
        ...
        partialUpdatedWallet.totalBalance(UPDATED_TOTAL_BALANCE).totalProvision(UPDATED_TOTAL_PROVISION);
